        ...
        <Nav className="mr-auto">
          ...
          <span className="d-block d-lg-none">
            ...
            <LinkContainer to="/favourites/">
              <Nav.Link>
                Favourites {favouritesTotal > 0 ? `(${favouritesTotal})` : null}
              </Nav.Link>
            </LinkContainer>
            <LinkContainer to="/basket/">
              <Nav.Link>
                Basket {basketTotal > 0 ? `(${basketTotal})` : null}
              </Nav.Link>
            </LinkContainer>
          </span>
        </Nav>
        <span className="navbar-page-icon d-none d-lg-block">
          <LinkContainer to="/favourites/">
            <Button variant="outline-danger">
              <FaHeart />{' '}
              <Badge>{favouritesTotal > 0 ? favouritesTotal : null}</Badge>
              <span className="sr-only">
                {favouritesTotal > 0 ? '' : 'Zero'} items in favourites
              </span>
            </Button>
          </LinkContainer>
          <LinkContainer to="/basket/">
            <Button variant="outline-primary">
              <BsBagFill />{' '}
              <Badge>{basketTotal > 0 ? basketTotal : null}</Badge>
              <span className="sr-only">
                {basketTotal > 0 ? '' : 'Zero'} items in basket
              </span>
            </Button>
          </LinkContainer>
        </span>
