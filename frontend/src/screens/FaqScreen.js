  ...
  const entries = [
    {
      ...
      answer:
        'Standard delivery takes 2-4 business days and costs £4.50, or is free for orders over £50. Next-day delivery takes 1-2 business days, costs £8, and is available before 12pm, Monday-Thursday.',
    },
    {
  ...
  return (
    <Container className="content-container px-4 pt-0 pb-3" fluid>
      <div className="bg-light-grey px-5 py-3 mt-0 round-edge">
        ...
        <div
          className="px-5 py-3 mt-5 w-100 round-edge"
        ...
        >
          ...
          <p className="p-0 m-0">
            Email:{' '}
            <a href="mailto:customerservice@goldenshoe.com">
              customerservice@goldenshoe.com
            </a>
          </p>
