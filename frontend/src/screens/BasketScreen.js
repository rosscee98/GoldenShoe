    ...
    return <Container className="content-container px-4 pt-0 pb-3" fluid>
        <div className="basket bg-light-grey px-3 py-2 mt-0 round-edge">
                            ...
                            : basketItems.map(item => 
                                <li>
                                    <Row className="product-row px-3 w-100">
                                        ...
                                        <Col xs={12} sm={6} md={3} className="bottom">
                                            <h3 className="text-muted">£{ (item.price * item.qty).toFixed(2) }</h3>
                                        </Col>
                                    </Row>
                                </li>    
                            )
            ...
            <div className="basket-action">
                ...
                <Button className="w-100 mt-2" onClick={ () => handleCheckout() } disabled={ basketItems.length === 0 }>Proceed to checkout</Button>
            </div>
        </div>
    </Container>
}
